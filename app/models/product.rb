class Product < ApplicationRecord
  ...
  validates :item_name, length: { maxinum: 40, message: 'please enter within 40 characters' }
  validates :explanation, length: { maxinum: 1000, message: 'please enter within 1000 characters' }
